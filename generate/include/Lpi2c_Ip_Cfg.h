...
#define LPI2C_IP_CFG_SW_MAJOR_VERSION              5
...
/* Check if current file and Lpi2c_Ip_PBcfg header file are of the same module */
#if (LPI2C_IP_CFG_MODULE_ID  != LPI2C_IP_PBCFG_MODULE_ID)
    #error "Lpi2c_Ip_Cfg.h and Lpi2c_Ip_PBcfg.h have different vendor ids"
#endif
/* Check if current file and Lpi2c_Ip_PBcfg header file are of the same vendor */
