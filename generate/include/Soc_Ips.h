...
/**
* @brief Hardware errata for ZIPWIRE: (ERR051988)
* @details ERR051988 LFAST: LVDS receiver pad fault is latched when receiver is enabled before the common voltage is settled on the line
*/
#define ERR_IPV_ZIPWIRE_E051988         (STD_ON)
