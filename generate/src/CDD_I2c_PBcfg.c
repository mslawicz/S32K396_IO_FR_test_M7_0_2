...
/* Check if current file and CDD_I2c_Ipw_PBcfg.h file are of the same vendor */
...
#endif
/* Check if current file and CDD_I2c_Ipw_PBcfg.h file are of the same Software version */
