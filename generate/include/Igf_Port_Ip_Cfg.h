...
#define IGF_PORT_IP_SW_MAJOR_VERSION_CFG_H                5
...
#endif
/* Check if the files Igf_Port_Ip_Cfg.h and Igf_Port_Ip_PBcfg.h are of the same Autosar version */
...
#endif
/* Check if the files Igf_Port_Ip_Cfg.h and Igf_Port_Ip_PBcfg.h are of the same software version */
...
*                                      DEFINES AND MACROS
==================================================================================================*/
/*! @brief User number of Igf configured pins */
#define IGF_NUM_OF_CHANNELS_CONFIG ((uint8)0U)
