...
{
    (Dio_PortLevelType)0x47FC,
    (Dio_PortLevelType)0xE7FE,
    (Dio_PortLevelType)0xFC3F,
    (Dio_PortLevelType)0x3FFF,
    (Dio_PortLevelType)0xFF3F,
    (Dio_PortLevelType)0xFFBF,
    (Dio_PortLevelType)0xFFFF,
    (Dio_PortLevelType)0xC3FF,
    (Dio_PortLevelType)0xCFB3,
    (Dio_PortLevelType)0xFCB9,
    (Dio_PortLevelType)0xFFFF,
    (Dio_PortLevelType)0xFFBF,
    (Dio_PortLevelType)0xFFFF,
    (Dio_PortLevelType)0x0FFF,
    (Dio_PortLevelType)0x1F80
};

const Dio_PortLevelType Dio_aAvailablePinsForRead[DIO_NUM_PORTS_U16] =
{
    (Dio_PortLevelType)0xC7FF,
    (Dio_PortLevelType)0xE7FF,
    (Dio_PortLevelType)0xFF3F,
    (Dio_PortLevelType)0x3FFF,
    (Dio_PortLevelType)0xFFFF,
    (Dio_PortLevelType)0xFFBF,
    (Dio_PortLevelType)0xFFFF,
    (Dio_PortLevelType)0xFFFF,
    (Dio_PortLevelType)0xCFF7,
    (Dio_PortLevelType)0xFCBF,
    (Dio_PortLevelType)0xFFFF,
    (Dio_PortLevelType)0xFFBF,
    (Dio_PortLevelType)0xFFFF,
    (Dio_PortLevelType)0x0FFF,
