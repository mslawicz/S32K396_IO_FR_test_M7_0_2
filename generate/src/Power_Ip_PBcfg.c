...
static const Power_Ip_MC_ME_CofbConfigType Power_Ip_MC_ME_aPartition1CofbConfigPB_0[4U] = 
{
    ...
    /* The configuration structure for Partition 1 COFB 1. */
    {
        ...
        (
            ((uint32)0x00000000U) | MC_ME_PRTN1_COFB1_CLKEN_REQ34_MASK | MC_ME_PRTN1_COFB1_CLKEN_REQ42_MASK | MC_ME_PRTN1_COFB1_CLKEN_REQ45_MASK | MC_ME_PRTN1_COFB1_CLKEN_REQ53_MASK
        ),
...
static const Power_Ip_MC_ME_CofbConfigType Power_Ip_MC_ME_aPartition3CofbConfigPB_0[3U] = 
{
    /* The configuration structure for Partition 3 COFB 0. */
    {
        /* Specifies whether the given COFB set is under MCU control. */
        (boolean)TRUE,
        ...
        /* Mask containing the COFB blocks to be updated. */
        MC_ME_PRTN3_COFB0_CLKEN_RWBITS_MASK
    },

    /* The configuration structure for Partition 3 COFB 1. */
    {
        /* Specifies whether the given COFB set is under MCU control. */
        (boolean)TRUE,
        ...
        /* Mask containing the COFB blocks to be updated. */
        MC_ME_PRTN3_COFB1_CLKEN_RWBITS_MASK
    },

    /* The configuration structure for Partition 3 COFB 2. */
    {
        /* Specifies whether the given COFB set is under MCU control. */
        (boolean)TRUE,
        ...
        /* Mask containing the COFB blocks to be updated. */
        MC_ME_PRTN3_COFB2_CLKEN_RWBITS_MASK
    }
...
static const Power_Ip_MC_ME_PartitionConfigType Power_Ip_MC_ME_aPartitionConfigPB_0[4U] = 
{
    ...
    /* The configuration structure for Partition 3. */
    {
        ...
        &Power_Ip_MC_ME_aPartition3CofbConfigPB_0,
...
static const Power_Ip_DCM_GPR_ConfigType Power_Ip_DCM_GPR_ConfigPB_0 =
{
    ...
    (
        POWER_IP_PMIC_PGOOD_BYPASSES_DISABLED
    ),
#endif
...
static const Power_Ip_PMC_ConfigType Power_Ip_PMC_ConfigPB =
{
    ...
    (
    ((uint32)0x00000000U) | PMC_CONFIG_LMSMPSEN_MASK
    )
    /* SMPS Configuration Register (SMPSCONFIG). */
    ,(
        ((uint32)0x00000000U)  | PMC_SMPSCONFIG_CFG(15U) | PMC_SMPSCONFIG_PERIOD(0U) | PMC_SMPSCONFIG_ONTIME3V(0U) | PMC_SMPSCONFIG_ONTIME5V(0U)
    )
};
